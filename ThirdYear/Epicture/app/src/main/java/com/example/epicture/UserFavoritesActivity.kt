...
class UserFavoritesActivity : AppCompatActivity()
{
    ...
    /**
     * onCreate
     * send a request to get the user favorites posts
     *
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.favorites_button).isClickable = false

        loadingDisplay = findViewById(R.id.loadingDisplayFavorites)
        ...
        ImgurApi.getMyFavorites(callback)
    }

    /**
     * apiResponseGestion
     * parse the data from the user posts api request & display the user favorites posts
     *
     * @param response
     */
