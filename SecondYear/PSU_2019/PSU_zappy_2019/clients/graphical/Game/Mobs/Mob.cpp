...
{
    inventory.food = inventoryData.food;
    inventory.linemate = inventoryData.linemate;
    inventory.thystmane = inventoryData.thystmane;
    inventory.deraumere = inventoryData.deraumere;
    inventory.sibur = inventoryData.sibur;
    inventory.mendiane = inventoryData.mendiane;
    inventory.phiras = inventoryData.phiras;
